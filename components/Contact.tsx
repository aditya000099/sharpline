      ...
      <div className="container mx-auto px-4">
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <button type="submit" className="w-full bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50 transition-colors">
                Send Message
              </button>
            </div>
          </form>
          {status && (
            <p className="mt-4 text-center text-indigo-600">{status}</p>
          )}
        </motion.div>
      </div>
    </section>
